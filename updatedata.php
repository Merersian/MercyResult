                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group  col-lg-3">
                                            ...
                                            <select name="grade" id="grade" class="form-control" required >
                                                ...
                                                <option value="gradeB" <?php if($Grade == "gradeB"){ echo "Selected"; } ?> >Grade 6</option>
                                                <option value="gradeC" <?php if($Grade == "gradeC"){ echo "Selected"; } ?> >Grade 7</option>
                                                <option value="gradeD" <?php if($Grade == "gradeD"){ echo "Selected"; } ?> >Grade 8</option>
                                                <option value="gradeE" <?php if($Grade == "gradeE"){ echo "Selected"; } ?> >Grade 9</option>
                                                <option value="gradeF" <?php if($Grade == "gradeF"){ echo "Selected"; } ?> >Grade 10</option>
                                            </select>
                                        </div>
                                        <div class="form-group col-lg-3">
